...
function ForgotPassword() {
    ...
    const navigate = useNavigate()
      const handleSubmit = async (e) =>{
        ...
        try {
            const response = await axios.post('https://myservicemate.online/api/forgot-password/', user);
    ...
    const handleOTPChange = (e, index) => {
      ...
      const handleVerifyOTP = () => {
        ...
        const apiUrl = 'https://myservicemate.online/api/reset-password'; // Replace with your backend API URL for OTP verification
