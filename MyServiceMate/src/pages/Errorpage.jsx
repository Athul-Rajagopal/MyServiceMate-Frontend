...
export default function ErrorPage() {
  ...
  const {isWorker,isAuthenticated} = userData
  ...
  const handleNavigation = () => {
    ...
    else if (isWorker && isAuthenticated) {
      navigate('/worker-home')
    } else if (!isWorker && isAuthenticated) {
      navigate("app/location")
    }
    // If isWorker is false or undefined, you can redirect to the landing page
    // Add the appropriate route for your landing page
