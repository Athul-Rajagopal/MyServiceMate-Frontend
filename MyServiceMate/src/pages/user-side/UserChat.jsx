...
import { fetch_user_messages } from '../../Services/UserService'; // Corrected import
...
function UserChat() {
  ...
  useEffect(() => {
    ...
    const newSocket = new WebSocket(`ws://myservicemate.online/ws/chat/${roomName}/`);
    setSocket(newSocket);
      ...
      <div className="flex flex-row h-full w-full  overflow-x-hidden">
        ...
        <div className="bg-white p-1 rounded-xl  flex justify-between">
          <div className="flex gap-3">
            ...
            <div> <p className="text-base font-semibold">worker</p>
